        ...
        <div className={styles.content}>
          ...
          >
            ...
            <div className={styles.contactGrid}>
              ...
              <div className={styles.contactItem}>
                <h3 className={styles.contactTitle}>Media społecznościowe</h3>
                <div className={styles.socialLinks}>
                  <a
                    href="https://wa.me/message/D4HHZMF7YUAQF1"
                    target="_blank"
                  ...
                  <a
                    href="https://www.facebook.com/uratuj.smartfona/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className={styles.socialLink}
                  ...
                  <a
                    href="https://www.instagram.com/uratuj_smartfona/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className={styles.socialLink}
